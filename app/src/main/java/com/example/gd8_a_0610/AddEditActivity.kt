package com.example.gd8_a_0610
...
import com.example.gd8_a_0610.api.MahasiswaApi
import com.example.gd8_a_0610.models.Mahasiswa
...
class AddEditActivity : AppCompatActivity() {
    ...
    private fun updateMahasiswa(id: Long) {
        ...
        val stringRequest: StringRequest =
            object : StringRequest(Method.POST, MahasiswaApi.UPDATE_URL, Response.Listener { response ->
                val gson = Gson()
                var mahasiswa = gson.fromJson(response, Mahasiswa::class.java)
